#ifndef EMP_CR_SIGNALGP_V2_LINEAR_PRG_EXECSTEPPER_H
#define EMP_CR_SIGNALGP_V2_LINEAR_PRG_EXECSTEPPER_H
...
#include "../crSignalGP.h"
#include "LinearProgram.h"

namespace emp { namespace sgp_cr {

// template<typename MEMORY_MODEL_T,typename TAG_T,typename INST_ARGUMENT_T,typename MATCHBIN_T>
// class crLinearProgramSignalGP;
  ...
  template<typename MEMORY_MODEL_T,
           ...
           > // typename ...SGP_Ts
  class crLinearProgramSignalGP : public crBaseSignalGP<crLinearProgramSignalGP<MEMORY_MODEL_T,TAG_T,INST_ARGUMENT_T,MATCHBIN_T>,
                                                        >
  {
  public:
    struct ExecState;
    ...
    using signalgp_t = crLinearProgramSignalGP<MEMORY_MODEL_T,
                                               TAG_T,
                                               INST_ARGUMENT_T,
                                               MATCHBIN_T>;
    ...
    using program_t = emp::sgp_v2::LinearProgram<tag_t, arg_t>;

    using base_hw_t = crBaseSignalGP<signalgp_t>;
    ...
    using inst_lib_t = InstructionLibrary<signalgp_t, inst_t, inst_prop_t>;
